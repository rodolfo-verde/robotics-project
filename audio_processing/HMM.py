...
VOCABULARY = ["a","b","c","eins","zwei","drei","rex","stopp", "nonsense"] # our commands
...
class CHMM(SignalFlowBlock.CSignalFlowBlock):
    ...
    def __ConfigureResultController(self):
        ResultController.TheResultController.AddCommand('a', StateMachine.TheStateMachine.triggerMotorALeftTurn)
        ResultController.TheResultController.AddCommand('b', StateMachine.TheStateMachine.triggerMotorARightTurn)
        ResultController.TheResultController.AddCommand('c', StateMachine.TheStateMachine.triggerMotorBRightTurn)
        ResultController.TheResultController.AddCommand('eins', StateMachine.TheStateMachine.triggerMotorBLeftTurn)
        ResultController.TheResultController.AddCommand('zwei', StateMachine.TheStateMachine.triggerMotorCRightTurn)
        ResultController.TheResultController.AddCommand('drei', StateMachine.TheStateMachine.triggerMotorCLeftTurn)
        ResultController.TheResultController.AddCommand('rex', StateMachine.TheStateMachine.triggerMotorDLeftTurn)
        ResultController.TheResultController.AddCommand('stopp', StateMachine.TheStateMachine.triggerMotorDRightTurn) 
        ResultController.TheResultController.AddCommand('nonsense', StateMachine.TheStateMachine.triggerMotorStop)
