...
class signalplotter:
    ...
    def setup_plots(self):
        ...
        #plt3w.axis([0, self.plotduration, -2, 2])
        ...
        self.plotvalues = np.array([[printblockraw, printvoiceactivity], [printblockfiltered, printworddetection], [printblockgained], [printwords]], dtype=object)
        ...
        self.plotlines = np.array([[linenofilter, lineactivity], [linewithfiler, lineworddetection], [linewithgain], [linewords]], dtype=object)
